...
export async function planAdScript({ product, lang = 'tr', highlights = [] }) {
  ...
  const system = [
    `Sen ProcessTürk için endüstriyel makine tanıtım videosu senaryosu yazıyorsun. Çıktı dili: ${langName}.`,
