...
export const TEMPLATES = [
  {
    ...
    buildPrompt(product, lang) {
      ...
      return [
        ...
        'Deep navy blue background gradient (#071739). Machine is the hero, centered and sharp.',
  ...
  },
  {
    ...
    label: 'Maskot',
    emoji: '🦸',
    desc: 'ProcessTürk maskotu makineyi tanıtıyor. Soul ID eğitimi gerektirir.',
    type: 'image',
    requiresSoulId: true,
    estimatedCost: '$0.05',
    buildPrompt(product, lang) {
      const name = product.name_en;
      return [
        `ProcessTürk mascot character next to a ${name} industrial machine.`,
        'Character is presenting the machine with an enthusiastic gesture.',
        'Modern industrial background. Bright, energetic colors. Professional quality.',
