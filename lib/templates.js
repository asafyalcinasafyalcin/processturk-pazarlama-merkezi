...
export const TEMPLATES = [
  ...
  },
  {
    ...
    label: 'Maskot',
    emoji: '🦸',
    desc: 'ProcessTürk robotu makineyi tanıtıyor. Soul ID hazırsa daha tutarlı.',
    type: 'image',
    requiresSoulId: true,
    estimatedCost: '$0.05',
    buildPrompt(product, lang) {
      const name = product.name_en;
      return [
        `ProcessTürk mascot robot character — a small friendly gray robot with big red eyes, red hard hat, red shoes — standing next to a ${name} industrial machine.`,
